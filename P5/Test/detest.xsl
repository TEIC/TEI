...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN schematron-constraint-detest-att.datable.w3c-att-datable-w3c-when-1-->
   ...
   <!--PATTERN schematron-constraint-detest-att.datable.w3c-att-datable-w3c-from-2-->
   ...
   <!--PATTERN schematron-constraint-detest-att.datable.w3c-att-datable-w3c-to-3-->
   ...
   <!--PATTERN schematron-constraint-detest-att.datable-calendar-calendar-4-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-detest-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-detest-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-detest-teidata.point-deprecate_trailing_decimal_point-9-->
   ...
   <!--PATTERN schematron-constraint-detest-p-c1-10-->
   ...
   <xsl:template match="tei:p" priority="1000" mode="M18">
      ...
      <xsl:if test="tei:list">
         <xsl:message> 
	    lists inside paragraphs not supported  (tei:list)</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M18"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-detest-p-c2-11-->


	  <!--RULE -->
   <xsl:template match="tei:p|tei:q" priority="1000" mode="M19">

		<!--REPORT -->
      <xsl:if test="contains(@rend,' ')">
         <xsl:message> 
		multi-valued rend is not supported  (contains(@rend,' '))</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M19"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-detest-p-abstractModel-structure-p-12-->
   ...
   <!--PATTERN schematron-constraint-detest-p-abstractModel-structure-l-13-->
   ...
   <!--PATTERN schematron-constraint-detest-desc-deprecationInfo-only-in-deprecated-14-->
   ...
   <!--PATTERN schematron-constraint-detest-ptr-ptrAtts-15-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-ref-refAtts-16-->
   ...
   <!--PATTERN schematron-constraint-detest-list-gloss-list-must-have-labels-17-->
   ...
   <!--PATTERN schematron-constraint-detest-relatedItem-targetorcontent1-18-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-detest-l-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-detest-lg-atleast1oflggapl-20-->
   ...
   <!--PATTERN schematron-constraint-detest-lg-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-detest-quotation-quotationContents-22-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-div-canondiv-25-->
   ...
   <xsl:template match="tei:div" priority="1000" mode="M31">
		...
		<!--REPORT -->
      <xsl:if test="@type='canon' and          parent::tei:div/@type='canon'">
         <xsl:message>
	      divs of type 'canon' may not be nested
	     (@type='canon' and parent::tei:div/@type='canon')</xsl:message>
      </xsl:if>

		    <!--REPORT -->
      <xsl:if test="@type='canon' and          parent::tei:div/@type='register'">
         <xsl:message>
	      divs of type 'canon' may not be nested within 'register'
	     (@type='canon' and parent::tei:div/@type='register')</xsl:message>
      </xsl:if>

		    <!--REPORT -->
      <xsl:if test="@type='canon' and count          (tei:div[@type='canonText']) &gt;1">
         <xsl:message>
	      divs of type 'canon' may contain only one 'canonText'
	     (@type='canon' and count (tei:div[@type='canonText']) &gt;1)</xsl:message>
      </xsl:if>

		    <!--REPORT -->
      <xsl:if test="@type='canonText' and           not(parent::tei:div[@type='canon'])">
         <xsl:message>
	      divs of type 'canonText' can only occur inside 'canon'
	     (@type='canonText' and not(parent::tei:div[@type='canon']))</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M31"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-detest-div-abstractModel-structure-l-26-->
   ...
   <!--PATTERN schematron-constraint-detest-div-abstractModel-structure-p-27-->
   ...
   <!--PATTERN schematron-constraint-detest-s-noNestedS-28-->
   ...
   <!--PATTERN schematron-constraint-detest-span-targetfrom-29-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-span-targetto-30-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-span-tonotfrom-31-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-span-tofrom-32-->
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-rdgGrp-only1lem-33-->


	  <!--RULE -->
   <xsl:template match="tei:rdgGrp" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-detest-variantEncoding-location-variantEncodingLocation-34-->


	  <!--RULE -->
   <xsl:template match="tei:variantEncoding" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-detest-path-pathmustnotbeclosed-35-->


	  <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-detest-addSpan-spanTo-36-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-detest-damageSpan-spanTo-38-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M43">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-delSpan-spanTo-40-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M44">
   ...
   <!--PATTERN schematron-constraint-detest-subst-substContents1-42-->
   ...
   <!--PATTERN schematron-constraint-detest-link-linkTargets3-43-->
   ...
   <!--PATTERN schematron-constraint-detest-ab-abstractModel-structure-ab-44-->


	  <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-detest-ab-abstractModel-structure-l-45-->
   ...
   <!--PATTERN schematron-constraint-detest-join-joinTargets3-46-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M49">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-catchwords-catchword_in_msDesc-47-->
   ...
   <!--PATTERN schematron-constraint-detest-dimensions-duplicateDim-48-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-secFol-secFol_in_msDesc-49-->
   ...
   <!--PATTERN schematron-constraint-detest-signatures-signatures_in_msDesc-50-->
   ...
   <!--PATTERN schematron-constraint-detest-msIdentifier-msId_minimal-51-->
   ...
   <!--PATTERN schematron-constraint-detest-att.repeatable-MINandMAXoccurs-52-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M55">
   ...
   <!--PATTERN schematron-constraint-detest-att.identified-spec-in-module-53-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-detest-att.deprecated-validUntil-deprecation-two-month-warning-54-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-detest-att.deprecated-validUntil-deprecation-should-be-explained-55-->
   ...
   <!--PATTERN schematron-constraint-detest-moduleRef-modref-56-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-detest-moduleRef-prefix-not-same-prefix-57-->
   ...
   <!--PATTERN schematron-constraint-detest-model-no_dup_default_models-58-->
   ...
   <!--PATTERN schematron-constraint-detest-model-no_dup_models-59-->
   ...
   <!--PATTERN schematron-constraint-detest-modelSequence-no_outputs_nor_predicates_4_my_kids-60-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M63">
   ...
   <!--PATTERN schematron-constraint-detest-content-empty-content-deprecated-61-->


	  <!--RULE -->
   <xsl:template match="tei:content" priority="1000" mode="M64">
   ...
   <!--PATTERN schematron-constraint-detest-sequence-sequencechilden-62-->
   ...
   <!--PATTERN schematron-constraint-detest-alternate-alternatechilden-63-->
   ...
   <!--PATTERN schematron-constraint-detest-constraintSpec-sch_no_more-64-->
   ...
   <!--PATTERN schematron-constraint-detest-constraintSpec-isosch-65-->
   ...
   <!--PATTERN schematron-constraint-detest-constraintSpec-needrules-66-->
   ...
   <!--PATTERN schematron-constraint-detest-attDef-attDefContents-67-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M70">
   ...
   <!--PATTERN schematron-constraint-detest-attDef-noDefault4Required-68-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M71">
   ...
   <!--PATTERN schematron-constraint-detest-attDef-defaultIsInClosedList-twoOrMore-69-->
   ...
   <!--PATTERN schematron-constraint-detest-attDef-defaultIsInClosedList-one-70-->
   ...
   <!--PATTERN schematron-constraint-detest-dataRef-restrictDataFacet-71-->
   ...
   <!--PATTERN schematron-constraint-detest-dataRef-restrictAttRestriction-72-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M75">
   ...
   <!--PATTERN schematron-constraint-detest-shift-shiftNew-73-->


	  <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M76">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-detest-blort3-schematron_isoschematron_OK-74-->


	  <!--RULE -->
   <xsl:template match="tei:blort3" priority="1000" mode="M77">
   ...
   <!--PATTERN isoschematron-constraint-detest-blort3-isoschematron_isoschematron_error-75-->


	  <!--RULE -->
   <xsl:template match="tei:blort3" priority="1000" mode="M78">
