...
<xsl:stylesheet 		
  ...
  <xsl:include href="docxfiles/settings.xsl"/>
    ...
    <xd:doc>
        <xd:short>Calls templates that are responsible for creating all necessary files besides the main document.xml</xd:short>
    </xd:doc>
    ...
    <xd:doc>
        ...
        <xd:detail>
            ...
            @param style          A style for all the w:ps
