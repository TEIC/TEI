...
\def\TheFullDate{1992-11-01 (revised: 
    1992-10)}
\def\TheID{dick1736\makeatother }
\def\TheDate{1992-11-01}
...
The Original Edition of A CHRISTMAS CAROL has been out of print for many years, and this Edition is a reprint from the stereotype plates of that Edition.
  \begin{titlepage}
\title{A Christmas carol. in prose.  — being \textgothic{A Ghost Story of Christmas}}by  \author{Charles Dickens.}With illustrations by John Leech
  \maketitle
  \end{titlepage}
  \cleardoublepage
