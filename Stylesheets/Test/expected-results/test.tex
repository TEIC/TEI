...
‘Who-e debel you?’ — he at last said — ‘you no speak-e, damme, I kill-e.’ And so saying, the lighted tomahawk began flourishing about me in the dark. \par 
\begin{longtable}{P{0.20944976076555025\textwidth}P{0.6405502392344498\textwidth}}
...
\section[Extended prose: MARLEY'S GHOST]{Extended prose: MARLEY'S GHOST}\label{S1}\par
...
\hspace*{6pt}{<\textbf{head}>}Choice, sic, corr, reg, orig\textbf{</\textbf{head}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{p}>}v{<\textbf{ex}>}oro\textbf{</\textbf{ex}>} þav sam{<\textbf{ex}>}m\textbf{</\textbf{ex}>}ędd syskin in\mbox{}\newline 
\hspace*{6pt}\hspace*{6pt} hei{<\textbf{ex}>}lagr\textbf{</\textbf{ex}>}i {<\textbf{lb}/>} ol{<\textbf{ex}>}afr\textbf{</\textbf{ex}>} k{<\textbf{ex}>}onvng\textbf{</\textbf{ex}>}r\mbox{}\newline 
\hspace*{6pt}{<\textbf{ex}>}ok\textbf{</\textbf{ex}>} fyrnefnd\mbox{}\newline 
\hspace*{6pt}{<\textbf{choice}>}\mbox{}\newline 
\hspace*{6pt}\hspace*{6pt}\hspace*{6pt}{<\textbf{sic}>}gvn{<\textbf{ex}>}n\textbf{</\textbf{ex}>}hillde\textbf{</\textbf{sic}>}\mbox{}\newline 
\hspace*{6pt}\hspace*{6pt}\hspace*{6pt}{<\textbf{corr}>}gvn{<\textbf{ex}>}n\textbf{</\textbf{ex}>}hilldr\textbf{</\textbf{corr}>}\mbox{}\newline 
\hspace*{6pt}\hspace*{6pt}\textbf{</\textbf{choice}>}.\textbf{</\textbf{p}>}\mbox{}\newline 
\textbf{</\textbf{div}>}\end{shaded}\egroup\par 
\end{itemize} 
\end{document}
