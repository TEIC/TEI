...
<xsl:stylesheet xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <xsl:key name="CHANGECONSTRAINT" match="tei:constraintSpec[@mode='change']"
            use="concat(../@ident,'_',@ident)"/>
  ...
  <xsl:key name="DELETECONSTRAINT" match="tei:constraintSpec[@mode='delete']"
            use="concat(../@ident,'_',@ident)"/>
  ...
  <xsl:key name="NEWATTCLASSES" match="tei:classSpec[@type='atts' and @mode='add']"
            use="@ident"/>
  ...
  <xsl:key name="REFED" use="substring-before(@name,'_')"
  ...
  <xsl:key name="REPLACEATT" match="tei:attDef[@mode='replace']"
            use="concat(../../@ident,'_',@ident)"/>
  <xsl:key name="REPLACECONSTRAINT" match="tei:constraintSpec[@mode='replace']"
            use="concat(../@ident,'_',@ident)"/>
  ...
  <xsl:template match="tei:valDesc|tei:equiv|tei:gloss|tei:desc|tei:remarks|tei:exemplum|tei:listRef"
                 mode="final">
      <xsl:choose>
