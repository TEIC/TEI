...
And then we have to consider quotations: 	\begin{quote}This is a block quote set off as such from the rest of the text,  	not to be confused with a quote which is run on within the text and will  	have quote marks of some kind around it.\end{quote} 	\par
