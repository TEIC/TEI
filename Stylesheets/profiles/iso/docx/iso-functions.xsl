...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:function name="teidocx:is-firstlevel-heading" as="xs:boolean">
        ...
        <xsl:choose>
            <xsl:when test="$p[w:pPr/w:pStyle/@w:val=$Heading1                 or w:pPr/w:pStyle/@w:val=$ANNEX                 or w:pPr/w:pStyle/@w:val=$ForewordHeading                 or w:pPr/w:pStyle/@w:val=$zzIntroductionHeading                 or w:pPr/w:pStyle/@w:val=$IntroductionHeading                 or w:pPr/w:pStyle/@w:val=$BibliographyHeading]">
                true
            </xsl:when>
            <xsl:otherwise>false</xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:function name="teidocx:is-heading" as="xs:boolean">
        <xsl:param name="p"/>
        <xsl:choose>
            <xsl:when test="$p[starts-with(w:pPr/w:pStyle/@w:val,'heading')                                  or w:pPr/w:pStyle/@w:val=$ANNEX                                  or w:pPr/w:pStyle/@w:val=$a2                                 or w:pPr/w:pStyle/@w:val=$a3                                 or w:pPr/w:pStyle/@w:val=$a4                                 or w:pPr/w:pStyle/@w:val=$a5                                 or w:pPr/w:pStyle/@w:val=$a6                                 or w:pPr/w:pStyle/@w:val=$BibliographyHeading                                  or w:pPr/w:pStyle/@w:val=$ForewordHeading                                   or w:pPr/w:pStyle/@w:val=$IntroductionHeading                                   or w:pPr/w:pStyle/@w:val=$zzIntroductionHeading]">
                true
            </xsl:when>
            <xsl:otherwise>false</xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:function name="teidocx:is-inline" as="xs:boolean">
        ...
        <xsl:for-each select="$element">
            <xsl:choose>
                <xsl:when test="self::m:oMath or     self::mml:math or     self::teidocx:dynamicContent or                          self::w:drawing or                     self::w:object or                            self::tei:formula[parent::cals:entry] or        self::tei:formula[parent::tei:title] or                      self::iso:wordObject[w:object] or                                          self::tei:abbr or                     self::tei:affiliation or                     self::tei:att or                     self::tei:author or                     self::tei:br or                     self::tei:c or                     self::tei:code or                     self::tei:editionStmt or                     self::tei:date or                     self::tei:emph or                                          self::tei:foreign or                     self::tei:forename or                     self::tei:graphic or                     self::tei:gi or                     self::tei:gloss[not(ancestor-or-self::*/@type='termsAndDefinitions')] or                     self::tei:hi[not(w:*)] or                     self::tei:idno or                     self::tei:ident or                     self::tei:lb or                     self::tei:name or                     self::tei:note[@place='foot'] or       self::tei:note[@place='bottom' ] or                     self::tei:note[@place='end'] or                     self::tei:num or                     self::tei:mentioned or                     self::tei:orgName or                     self::tei:placeName or                     self::tei:persName or                     self::tei:publisher or                     self::tei:pb or                     self::tei:ptr or                     self::tei:q[not(@type='sdt')] or                     self::tei:ref or                     self::tei:seg or                     self::tei:surname or                      self::tei:soCalled or                     self::tei:term[not(ancestor-or-self::*/@type='termsAndDefinitions')] or                     self::tei:val or                     self::tei:title">
                    true
                </xsl:when>
                <xsl:otherwise>
                    <xsl:choose>
