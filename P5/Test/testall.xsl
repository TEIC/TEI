...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN schematron-constraint-testall-att.datable.w3c-att-datable-w3c-when-1-->
   ...
   <!--PATTERN schematron-constraint-testall-att.datable.w3c-att-datable-w3c-from-2-->
   ...
   <!--PATTERN schematron-constraint-testall-att.datable.w3c-att-datable-w3c-to-3-->
   ...
   <!--PATTERN schematron-constraint-testall-att.datable-calendar-calendar-4-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-testall-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-testall-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-testall-teidata.point-deprecate_trailing_decimal_point-9-->
   ...
   <!--PATTERN schematron-constraint-testall-p-abstractModel-structure-p-10-->
   ...
   <!--PATTERN schematron-constraint-testall-p-abstractModel-structure-l-11-->
   ...
   <!--PATTERN schematron-constraint-testall-desc-deprecationInfo-only-in-deprecated-12-->
   ...
   <!--PATTERN schematron-constraint-testall-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-testall-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-testall-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-testall-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-testall-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-testall-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-testall-s-noNestedS-20-->
   ...
   <!--PATTERN schematron-constraint-testall-span-targetfrom-21-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-span-targetto-22-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-span-tonotfrom-23-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-span-tofrom-24-->
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-quotation-quotationContents-25-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-link-linkTargets3-26-->
   ...
   <!--PATTERN schematron-constraint-testall-ab-abstractModel-structure-ab-27-->
   ...
   <!--PATTERN schematron-constraint-testall-ab-abstractModel-structure-l-28-->
   ...
   <!--PATTERN schematron-constraint-testall-join-joinTargets3-29-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-catchwords-catchword_in_msDesc-30-->
   ...
   <!--PATTERN schematron-constraint-testall-dimensions-duplicateDim-31-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-secFol-secFol_in_msDesc-32-->
   ...
   <!--PATTERN schematron-constraint-testall-signatures-signatures_in_msDesc-33-->
   ...
   <!--PATTERN schematron-constraint-testall-msIdentifier-msId_minimal-34-->
   ...
   <!--PATTERN schematron-constraint-testall-relation-reforkeyorname-35-->
   ...
   <!--PATTERN schematron-constraint-testall-relation-activemutual-36-->
   ...
   <!--PATTERN schematron-constraint-testall-relation-activepassive-37-->
   ...
   <!--PATTERN schematron-constraint-testall-objectIdentifier-objectIdentifier_minimal-38-->
   ...
   <!--PATTERN schematron-constraint-testall-shift-shiftNew-39-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-testall-att.repeatable-MINandMAXoccurs-40-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M48">
   ...
   <!--PATTERN schematron-constraint-testall-att.identified-spec-in-module-41-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-testall-att.deprecated-validUntil-deprecation-two-month-warning-42-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-testall-att.deprecated-validUntil-deprecation-should-be-explained-43-->
   ...
   <!--PATTERN schematron-constraint-testall-moduleRef-modref-44-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M52">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-moduleRef-prefix-not-same-prefix-45-->
   ...
   <!--PATTERN schematron-constraint-testall-model-no_dup_default_models-46-->
   ...
   <!--PATTERN schematron-constraint-testall-model-no_dup_models-47-->
   ...
   <!--PATTERN schematron-constraint-testall-modelSequence-no_outputs_nor_predicates_4_my_kids-48-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-testall-content-empty-content-deprecated-49-->


	  <!--RULE -->
   <xsl:template match="tei:content" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-testall-sequence-sequencechilden-50-->
   ...
   <!--PATTERN schematron-constraint-testall-alternate-alternatechilden-51-->
   ...
   <!--PATTERN schematron-constraint-testall-constraintSpec-sch_no_more-52-->
   ...
   <!--PATTERN schematron-constraint-testall-constraintSpec-isosch-53-->
   ...
   <!--PATTERN schematron-constraint-testall-constraintSpec-needrules-54-->
   ...
   <!--PATTERN schematron-constraint-testall-attDef-attDefContents-55-->
   ...
   <!--PATTERN schematron-constraint-testall-attDef-noDefault4Required-56-->
   ...
   <!--PATTERN schematron-constraint-testall-attDef-defaultIsInClosedList-twoOrMore-57-->
   ...
   <!--PATTERN schematron-constraint-testall-attDef-defaultIsInClosedList-one-58-->
   ...
   <!--PATTERN schematron-constraint-testall-dataRef-restrictDataFacet-59-->
   ...
   <!--PATTERN schematron-constraint-testall-dataRef-restrictAttRestriction-60-->
   ...
   <!--PATTERN schematron-constraint-testall-rdgGrp-only1lem-61-->
   ...
   <!--PATTERN schematron-constraint-testall-variantEncoding-location-variantEncodingLocation-62-->
   ...
   <!--PATTERN schematron-constraint-testall-div-abstractModel-structure-l-65-->
   ...
   <!--PATTERN schematron-constraint-testall-div-abstractModel-structure-p-66-->
   ...
   <!--PATTERN schematron-constraint-testall-path-pathmustnotbeclosed-67-->
   ...
   <!--PATTERN schematron-constraint-testall-addSpan-spanTo-68-->
   ...
   <!--PATTERN schematron-constraint-testall-damageSpan-spanTo-70-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-testall-delSpan-spanTo-72-->
   ...
   <!--PATTERN schematron-constraint-testall-subst-substContents1-74-->
