...
-->
  ...
  <xsl:template mode="mml" match="mml:mi[not(child::mml:mglyph)] | 
    ...
    <xsl:variable name="sLowerActiontype">
      <xsl:choose>
        <xsl:when test="$ndCur/ancestor::mml:maction[@actiontype='lit']/@actiontype">
          <xsl:value-of select="translate($ndCur/ancestor::mml:maction[@actiontype='lit']/@actiontype, $StrUCAlphabet, 
                                                                                                     $StrLCAlphabet)"/>
        </xsl:when>
        <xsl:otherwise>
          <xsl:value-of select="translate($ndCur/ancestor::mml:maction[@actiontype='lit']/@mml:actiontype, $StrUCAlphabet, 
                                                                                                     $StrLCAlphabet)"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template mode="mml" match="mml:mi[child::mml:mglyph] | 
  ...
  <xsl:template name="CreateMglyph">
    ...
    <m:r>
      <xsl:call-template name="CreateRunProp">
        <xsl:with-param name="mathvariant">
          <xsl:choose>
            <xsl:when test="(not(@mathvariant) or @mathvariant='') 
                            and (not(@mml:mathvariant) or @mml:mathvariant='')
                            and (../@mathvariant!='' or ../@mml:mathvariant!='')">
              <xsl:choose>
                <xsl:when test="../@mathvariant">
                  <xsl:value-of select="../@mathvariant"/>
                </xsl:when>
        ...
        <xsl:with-param name="fontstyle">
          <xsl:choose>
            <xsl:when test="(not(@fontstyle) or @fontstyle='') 
                            and (not(@mml:fontstyle) or @mml:fontstyle='')
                            and (../@fontstyle!='' or ../@mml:fontstyle!='')">
              <xsl:choose>
                <xsl:when test="../@fontstyle">
                  <xsl:value-of select="../@fontstyle"/>
                </xsl:when>
        ...
        <xsl:with-param name="fontweight">
          <xsl:choose>
            <xsl:when test="(not(@fontweight) or @fontweight='') 
                            and (not(@mml:fontweight) or @mml:fontweight='')
                            and (../@fontweight!='' or ../@mml:fontweight!='')">
              <xsl:choose>
                <xsl:when test="../@fontweight">
                  <xsl:value-of select="../@fontweight"/>
                </xsl:when>
        ...
        <xsl:with-param name="mathcolor">
          <xsl:choose>
            <xsl:when test="(not(@mathcolor) or @mathcolor='') 
                            and (not(@mml:mathcolor) or @mml:mathcolor='')
                            and (../@mathcolor!='' or ../@mml:mathcolor!='')">
              <xsl:choose>
                <xsl:when test="../@mathcolor">
                  <xsl:value-of select="../@mathcolor"/>
                </xsl:when>
        ...
        <xsl:with-param name="mathsize">
          <xsl:choose>
            <xsl:when test="(not(@mathsize) or @mathsize='')
                            and (not(@mml:mathsize) or @mml:mathsize='')
                            and (../@mathsize!='' or ../@mml:mathsize!='')">
              <xsl:choose>
                <xsl:when test="../@mathsize">
                  <xsl:value-of select="../@mathsize"/>
                </xsl:when>
        ...
        <xsl:with-param name="color">
          <xsl:choose>
            <xsl:when test="(not(@color) or @color='') 
                            and (not(@mml:color) or @mml:color='')
                            and (../@color!='' or ../@mml:color!='')">
              <xsl:choose>
                <xsl:when test="../@color">
                  <xsl:value-of select="../@color"/>
                </xsl:when>
        ...
        <xsl:with-param name="fontsize">
          <xsl:choose>
            <xsl:when test="(not(@fontsize) or @fontsize='')
                            and (not(@mml:fontsize) or @mml:fontsize='')
                            and (../@fontsize!='' or ../@mml:fontsize!='')">
              <xsl:choose>
                <xsl:when test="../@fontsize">
                  <xsl:value-of select="../@fontsize"/>
                </xsl:when>
