...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:function name="ebb:flowchart">
        ...
        <xsl:variable name="level" as="xs:integer" select="$input/ancestor::*/name() => distinct-values() => count()"/>
        <g class="level-{$level}">
    ...
    <xsl:template match="/">
        <svg width="100%" height="100%" viewBox="0 0 2000 1350">
            <defs>
            ...
            <g id="root" transform="translate(400, 900)">            
