...
\catcode`\%=12\relax
 \frontmatter 
  \begin{titlepage}
  \docTitle{ \titlePart{Ridván 2009 Botschaft des Universalen Hauses der Gerechtigkeitan die Bahá’í der Welt}}\byline{durch \docAuthor{Das Universale Haus der Gerechtigkeit}}\docImprint{Copyright © \docDate{Ridván 2009}, alle Rechte vorbehalten, Bahá’íWeltzentrum, Haifa, Israel. }
  \end{titlepage}
  \cleardoublepage
