...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0"
                exclude-result-prefixes="a cp dc dcterms dcmitype prop     iso m mml mo mv o pic r rel     tbx tei teidocx v xs ve w10 w wne wp xd">
    ...
    <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl">
      <desc>
        Convert special characters (w:syms) into c tags.
    </desc>
   </doc>
