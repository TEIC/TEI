...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xd:doc>
        <xd:short>Handles a single paragraph that contains a math object</xd:short>
        <xd:detail>
        </xd:detail>
    </xd:doc>
    ...
    <xd:doc>
        <xd:short>named template for w:p[w:pPr/w:pStyle/@w:val='Formula'</xd:short>
        <xd:detail>
        </xd:detail>
    </xd:doc>
    ...
    <xd:doc>
        <xd:short>Depending on the math mode, omml is either converted to mathML or an identity transformation is started</xd:short>
    </xd:doc>
    ...
    <xd:doc>
        <xd:short>Handles a w:object</xd:short>
        <xd:detail>
