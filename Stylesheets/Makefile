...
DIRS=bibtex common2 docx dtd docbook epub epub3 fo2 html html5 json latex2 nlm odds2 odt profiles/default rdf relaxng rnc slides tbx tcp tite tools txt xhtml2 xsd xlsx pdf
