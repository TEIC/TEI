...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xd:doc>
        <xd:short>Calls the named template paragraph-wp that can be overriden.</xd:short>
        <xd:detail>
    ...
    <xd:doc>
        <xd:short>named Template for w:p</xd:short>
    </xd:doc>
	  ...
	  <xsl:choose>
	    <xsl:when test="w:pPr/w:rPr/w:ins">
	      <add when="{w:pPr/w:rPr/w:ins/@w:date}"
		   resp="#{w:pPr/w:rPr/w:ins/@w:author}" type="para">
