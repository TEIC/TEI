...
class romaDom extends domDocument
  {
	...
	$oTitle->appendChild( new domText( 'My LMF Extension' ) );
	$oAuthor = $oTitleStmt->appendChild( new domElement( 'author' ) );
	$oAuthor->appendChild( new domText( 'generated by RomaLMF ' . roma_version ) );
...
//Tuesday 13th 2006f June 2006 10:57:23 PM
	...
	$oBodyP->appendChild( new domText( 'My LMF Customization
	starts with modules LMFCore' ) );
	...
	$oSchema->setAttribute('start', 'LexicalResource' );
