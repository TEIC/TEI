...
\catcode`\%=12\relax
\frontmatter 
\DivI[(half title note)]{(half title note)}\par
...
\begin{longtable}{P{0.22917505030181085\textwidth}P{0.6208249496981891\textwidth}}
 \hline\endfoot\hline\endlastfoot \rowcolor{label}Effect\tabcellsep Example\\\hline 
