...
if grep -q 14.04 /etc/lsb-release
...
apt-get -y install openssh-server libxml2 libxml2-utils devscripts xsltproc libsaxonhe-java debhelper subversion trang jing zip &&
