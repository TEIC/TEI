...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- 
         ...
         URI and the prefix assigned, and generate a single <tmp:nss>
  ...
  <!-- 
         Next, group the nodes into sets based on only on the namespace
         URI, and generate a single <tmp:nss>
         element for each such set, which element contains the needed
         information about this set (or group) of namespaces: their
         prefixes (on @pfx), their namespace URI (on @uri), and the
         count of namespaces (i.e. <tmp:ns>) that have that particular
         combination namespace URI.
    -->
  ...
  <xsl:template name="head">
    <head>
      ...
      <style type="text/css">
        body { padding: 2em; }
        table#one > thead { background-color: #D0E1F2; padding: 0.6ex; }
        table#two > thead { background-color: #E1F2D0; padding: 0.6ex; }
        table#one { background-color: #F7F9FB; }
        table#two { background-color: #F9FBF7; }
  ...
  <xsl:template name="preTables">
    ...
    <p>Namespace nodes in p5.xml. See colophon (below tables) for
    ...
    <dl>
      ...
      <dt style="background-color: #D0E1F2;">count</dt>
      <dd>The number of times this namespace URI occurs in the input document.</dd>
      <dt style="background-color: #E1F2D0;">count</dt>
      ...
      <dt style="background-color: #D0E1F2;">prefixes</dt>
      <dd>The namespace prefixes used for this URI (in reverse alphabetic order).</dd>
      <dt style="background-color: #E1F2D0;">prefix</dt>
