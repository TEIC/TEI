...
[en]
helpmessage=Specify a language for internationalization
headline=Choose a different language
form_headline=Do you want the output schema to use a different language?
...
form_doclanguage=Linguaggio per la documentazione
...
[sw]
helpmessage=Specificera ett språk för internationalisering
headline=Välj ett annat språk
form_headline=Vill du använda ett annat språk i ditt schema?
form_language=Språk för element och attributnamn
...
[pt]
helpmessage=Especificar a língua 
headline=Escolher uma língua diferente
