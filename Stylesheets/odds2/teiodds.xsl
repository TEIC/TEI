...
<xsl:stylesheet xmlns:html="http://www.w3.org/1999/xhtml" xmlns:i="http://www.iso.org/ns/1.0"
  ...
  <xsl:key match="tei:elementSpec/tei:attList/tei:attDef/tei:datatype/rng:ref"
            name="ATTREFS-ELEMENT"
            use="@name"/>
  <xsl:key match="tei:classSpec/tei:attList/tei:attDef/tei:datatype/rng:ref"
            name="ATTREFS-CLASS"
            use="@name"/>
  ...
  <xsl:key match="tei:macroSpec[@predeclare='true']" name="PredeclareMacrosModule"
            use="@module"/>
...
-->
  ...
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl">
      <desc>Process elements tei:schemaSpec</desc>
   </doc>
