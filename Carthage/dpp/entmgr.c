...
*/
    ...
    FILESTATUS(yyin,"yyin");
         ...
         MsgKwS(msgDEBUG,"Opening entity ",pName," (internal)",NULL);
         yy_switch_to_buffer(yy_create_buffer(yyin,YY_BUF_SIZE));
...
#ifdef DEBUGGING
    FILESTATUS(stdout,"stdout");
    MsgKwS(msgDEBUG,"Closing the current entity ...",NULL);
    MsgKwS(msgDEBUG,"PCCloseentity() called ...",NULL);
    FILESTATUS(stdout,"stdout");
    FILESTATUS(stdin,"stdin");
    FILESTATUS(stderr,"stderr");
    FILESTATUS(yyin,"yyin");
