...
headline=Element verändern
form_headline=Neues Element definieren
form_name=Name
...
[ja]
helpmessage=新規に要素を定義したり、既存の要素を変更することができます。
headline=要素の変更
form_headline=要素の定義
form_name=要素名
...
[pt]
helpmessage=Este formulário permite criar um elemento novo ou modificar um elemento já existente
headline=Modificar um elemento 
form_headline=Definir um elemento novo
form_name=Nome
form_modelClasses=Classes do modelo
form_attributeClasses=Classes dos atributos
